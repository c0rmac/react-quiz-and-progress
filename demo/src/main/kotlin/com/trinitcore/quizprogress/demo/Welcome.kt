...
import com.trinitcore.quizprogress.demo.wrapper.hoCAnimatedSwitch
...
class Welcome(props: WelcomeProps) : RComponent<WelcomeProps, WelcomeState>(props) {
    ...
    private fun handleMatrixQuestionAnswered(difficultyFieldID: Int) {
        // console.log("handleMatrixQuestionAnswered")
        setState {
            this.controller?.tryAnsQuesAndGoToNxtQues(difficultyFieldID) { ques, ansFieldID ->
                // load(hideLoadingIndic = true) { api.setAnswerForQuestionByID(ques.id, ansFieldID) }
            }
        }
    }
